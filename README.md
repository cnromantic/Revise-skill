# Revise Agent Skill V3.2

本次更新（V3.2）主要修正中英文混排空格规则：中文正文中汉字与英文单词、英文缩写、阿拉伯数字之间通常保留或补充半角空格，不再把这类空格视为多余；但英文部分紧邻中文标点符号时，英文与中文标点之间不设空格。同步更新了相关验收规则，避免批量误删 `AI`、`PDF`、`Spring Boot`、`RBAC` 等术语前后的必要空格。
